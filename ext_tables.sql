...
#
# Table structure for table 'tx_cadabra_domain_model_orderable_article'
#
CREATE TABLE tx_cadabra_domain_model_orderable_article (
	...
	record_type varchar(255) DEFAULT '' NOT NULL,
	article int(11) DEFAULT '0' NOT NULL,
	basket int(11) DEFAULT '0' NOT NULL,

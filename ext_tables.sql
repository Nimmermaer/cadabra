#
# Table structure for table 'tx_cadabra_domain_model_product'
#
CREATE TABLE tx_cadabra_domain_model_product (
...
#
# Table structure for table 'tx_cadabra_domain_model_article'
#
CREATE TABLE tx_cadabra_domain_model_article (
...
#
# Table structure for table 'tx_cadabra_domain_model_article_feature'
#
CREATE TABLE tx_cadabra_domain_model_article_feature (
	...
	attribute_value int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_cadabra_domain_model_attribute'
#
CREATE TABLE tx_cadabra_domain_model_attribute (
...
#
# Table structure for table 'tx_cadabra_domain_model_information_group'
#
# noinspection SqlNoDataSourceInspection
CREATE TABLE tx_cadabra_domain_model_information_group (
	...
	name varchar(255) DEFAULT '' NOT NULL,
	render_method varchar(255) DEFAULT '' NOT NULL,
...
#
# Table structure for table 'tx_cadabra_domain_model_information'
#
CREATE TABLE tx_cadabra_domain_model_information (
	...
	information_group int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_cadabra_domain_model_address'
#
CREATE TABLE tx_cadabra_domain_model_address (
...
#
# Table structure for table 'tx_cadabra_domain_model_basket'
#
CREATE TABLE tx_cadabra_domain_model_basket (
...
#
# Table structure for table 'tx_cadabra_domain_model_shippinmethod'
#
CREATE TABLE tx_cadabra_domain_model_shippingmethod (
...
#
# Table structure for table 'tx_cadabra_domain_model_invoice'
#
CREATE TABLE tx_cadabra_domain_model_invoice (
...
#
# Table structure for table 'tx_cadabra_domain_model_deliveryreciept'
#
CREATE TABLE tx_cadabra_domain_model_deliveryreciept (
...
#
# Table structure for table 'tx_cadabra_domain_model_ordering'
#
CREATE TABLE tx_cadabra_domain_model_ordering (
...
#
# Table structure for table 'tx_cadabra_domain_model_paymentmethod'
#
CREATE TABLE tx_cadabra_domain_model_paymentmethod (
...
#
# Table structure for table 'tx_cadabra_domain_model_orderablearticle'
#
CREATE TABLE tx_cadabra_domain_model_orderablearticle (
...
#
# Table structure for table 'tx_cadabra_domain_model_orderingposition'
#
CREATE TABLE tx_cadabra_domain_model_orderingposition (
